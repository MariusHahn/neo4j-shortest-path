...
is the case if either we haven't seen this vertex so far or the state we pushed with this vertex before contains a longer path as the one we just found.
