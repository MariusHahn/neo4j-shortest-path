...
public record NodeExcludeExpander(Node restrictedNode, PathExpander<Double> expander)
        implements PathExpander<Double> {

    public NodeExcludeExpander(Node restrictedNode, RelationshipType relationshipType) {
        this(restrictedNode
    ...
    public PathExpander<Double> reverse() {
        return new NodeExcludeExpander(restrictedNode, expander.reverse());
    }
}
