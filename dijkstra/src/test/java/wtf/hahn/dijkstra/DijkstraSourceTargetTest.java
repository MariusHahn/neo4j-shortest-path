...
import wtf.hahn.neo4j.dijkstra.procedure.DijkstraSourceTarget;
...
public class DijkstraSourceTargetTest extends IntegrationTest {
    ...
    @ParameterizedTest
    @ValueSource(strings = {
            "wtf.hahn.neo4j.dijkstra.procedure.sourceTarget",
            "wtf.hahn.neo4j.dijkstra.procedure.sourceTargetNative",
    })
