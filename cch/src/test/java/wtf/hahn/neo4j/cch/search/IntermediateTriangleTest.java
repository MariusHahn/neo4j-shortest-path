...
public class IntermediateTriangleTest extends IntegrationTest {

    @TempDir
    private static Path path;

    public IntermediateTriangleTest() {
        super(of(), of(), of(), TestDataset.INTERMEDIATE_TRIANGLE);
    ...
    void intermediateTriangleTest(Integer i, Integer j) {
